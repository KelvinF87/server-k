...
const { handleCreate, handleGetAll, handleGetOne, handleUpdate, handleDelete, handleGetAllUserAdmin } = require("../utils/crud");

const tipoEntradaRouter = express.Router();

tipoEntradaRouter.post("/", isAuthenticated, (req, res) => handleCreate(TipoEntrada, req, res));
tipoEntradaRouter.get("/", isAuthenticated, (req, res) => handleGetAllUserAdmin(TipoEntrada, req, res));
